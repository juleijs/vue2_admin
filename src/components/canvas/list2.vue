    ...
    <el-row class="warp">
        <el-col :span="24" class="warp-breadcrumb">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>简单动画</el-breadcrumb-item>
            </el-breadcrumb>
        </el-col>
        <el-col :span="24" class="warp-main">
            <p>
                <canvas id="canvas01" width="600px" height="40px">
            ...
            <div class="look">
                <p>
                    <el-button @click="rotateImage('left')" size="mini">左旋转</el-button>
                    <el-button @click="rotateImage('right')" size="mini">右旋转</el-button>
                </p>
                <canvas id="canvas04" width="220px" height="220px"></canvas>
            </div>
            <div class="look">
                <p>
                    <el-button @click="turnImage()" size="mini">翻转</el-button>
                </p>
                <canvas id="canvas05" width="220px" height="220px"></canvas>
            </div>
        </el-col>
    </el-row>
</template>
...
export default {
    ...
    methods: {
        ...
        turnImage(i) {
            let that = this;
            let c = document.getElementById("canvas05");
