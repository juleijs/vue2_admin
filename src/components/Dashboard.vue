<template>
    <el-row class="warp">
        <el-col class="warp-breadcrumb" :span="24">
        ...
        <el-col class="warp-main" :span="24">
            <section class="chart-container">
                <el-row>
                        ...
                        <el-card :body-style="{ padding: '0px' }">
                            ...
                            <div style="padding: 14px;">
                                ...
                                <div class="bottom clearfix">
                                    <time class="time">{{ currentDate | dateFmt }}</time>
                                </div>
                            </div>
                        </el-card>
                    </el-col>
                    ...
                    <el-col :span="12">
                        <div id="chartBar" class="charts"></div>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="24">
                        <a href="http://echarts.baidu.com/examples.html" target="_blank">more>></a>
                    </el-col>
                </el-row>
            </section>
        </el-col>
